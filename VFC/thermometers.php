                ...
                <tbody>
                  ...
                  <?php
                    ...
                    if(isset($_GET['search']))
                    {
                      ...
                      $query = "SELECT * FROM Thermometers WHERE CONCAT(pin,name,county,location,model,serial) LIKE '%$filtervalues%' ";
                      ...
                      if(mysqli_num_rows($query_run) > 0)
                      {
                        foreach ($query_run as $providers)
                        {
                          ...
                          <tr>
                            ...
                            <td><?= $providers['model']; ?></td>
                            <td><?= $providers['serial']; ?></td>
                            <td><?= $providers['exp']; ?></td>
                          </tr>
                          <?php
                        }
