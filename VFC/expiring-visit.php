...
<html lang="en">
  <head>
    ...
    <title>Overdue in 90 days</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-light sticky-top">
          ...
          <ul class="navbar-nav me-4 nav nav-tabs" style="--bs-scroll-height: 100px;">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item active" href="expiring-visit.php">Overdue in 90 days</a></li>
                <li><hr class="dropdown-divider"></li>
      ...
      <div class="header">
        <h3>MyVFC-Overdue in 90 days</h3>
      </div>
              ...
              <div class="card-body">
                <table class="table table-hover">
                  ...
                  <tbody>
                      ...
                      <?php
                        // Display Activity
                        $query1 = "SELECT * FROM Activities WHERE next BETWEEN CURDATE() and DATE_ADD(CURDATE(), INTERVAL 90 DAY)";
                        ...
                        if(mysqli_num_rows($query_run1) > 0 )
                        {
                          foreach ($query_run1 as $date)
                          {
                            ...
                            <tr>
                              ...
                              <td><?= $date['rep']; ?></td>
                              <td><?= $date['date']; ?></td>
                              <td style="color:#FFA500"><?= $date['next']; ?></td>
                              <td>
                                <a href="email-expiring-activity.php?id=<?= $date['pin']; ?>" class="btn btn-outline-success btn-sm" target="_blank">Email</a>
                              </td>
                            </tr>
                            <?php
                        }
